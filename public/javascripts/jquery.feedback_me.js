...
var fm = (function ($) {
	...
	function appendFeedbackToBody(fm_options) {
		...
		$('body').append('<div id="fm_main_content" class="feedback_content feedback_content_closed ' + fm_options.position + email_feedback_content_class + radio_button_list_class + jQueryUIClasses2 + fm_class + jquery_class + bootstrap_class + bootstrap_hero_unit + '">'
        ...
        if (fm_options.html_url !== undefined) {
            $("#fm_main_content").load(fm_options.html_url);
        }
